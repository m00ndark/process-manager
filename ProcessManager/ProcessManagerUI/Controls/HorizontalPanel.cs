...
namespace ProcessManagerUI.Controls
{
	...
	public class HorizontalPanel : Panel
	{
		...
		/// box).  This should help to isolate the developer from having to research 
		/// 
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			rect = new Rectangle(0, 1, Width, 1);
			sb.Color = aeroColor2;
			e.Graphics.FillRectangle(sb, rect);

			rect = new Rectangle(0, 2, Width, 1);
			sb.Color = aeroColor3;
			e.Graphics.FillRectangle(sb, rect);

			rect = new Rectangle(0, 3, Width, 1);
			sb.Color = aeroColor3;
			e.Graphics.FillRectangle(sb, rect);

			rect = new Rectangle(0, 4, Width, 1);
			sb.Color = aeroColor4;
			e.Graphics.FillRectangle(sb, rect);

			rect = new Rectangle(0, 5, Width, 1);
			sb.Color = aeroColor5;
			e.Graphics.FillRectangle(sb, rect);

			rect = new Rectangle(0, 6, Width, Height - 5);
			sb.Color = aeroColor6;
			e.Graphics.FillRectangle(sb, rect);
